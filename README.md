...
1. ✌️ Released [v0.1.0](https://github.com/DevzoneCommunity/faag_cli/releases/tag/v0.1.0) in [DevzoneCommunity/faag_cli](https://github.com/DevzoneCommunity/faag_cli)
2. ⬆️ Pushed 1 commit(s) to [DevzoneCommunity/faag_cli](https://github.com/DevzoneCommunity/faag_cli)
3. ⬆️ Pushed 6 commit(s) to [DevzoneCommunity/faag_cli](https://github.com/DevzoneCommunity/faag_cli)
4. 🎉 Merged PR [#51](https://github.com/DevzoneCommunity/faag_cli/pull/51) in [DevzoneCommunity/faag_cli](https://github.com/DevzoneCommunity/faag_cli)
