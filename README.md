...
2. ⬆️ Pushed 2 commit(s) to [pythonhubdev/split_bill_api](https://github.com/pythonhubdev/split_bill_api)
3. 🎉 Merged PR [#2](https://github.com/pythonhubdev/split_bill_api/pull/2) in [pythonhubdev/split_bill_api](https://github.com/pythonhubdev/split_bill_api)
4. 💪 Opened PR [#2](https://github.com/pythonhubdev/split_bill_api/pull/2) in [pythonhubdev/split_bill_api](https://github.com/pythonhubdev/split_bill_api)
5. ⬆️ Pushed 3 commit(s) to [pythonhubdev/split_bill_api](https://github.com/pythonhubdev/split_bill_api)
<!--RECENT_ACTIVITY:end-->
