...
1. ⬆️ Pushed 6 commit(s) to [DevzoneCommunity/faag_cli](https://github.com/DevzoneCommunity/faag_cli)
2. ⬆️ Pushed 1 commit(s) to [DevzoneCommunity/lets_solve_problems](https://github.com/DevzoneCommunity/lets_solve_problems)
3. ⬆️ Pushed 1 commit(s) to [DevzoneCommunity/lets_solve_problems](https://github.com/DevzoneCommunity/lets_solve_problems)
4. ✌️ Released [v0.1.2](https://github.com/DevzoneCommunity/faag_cli/releases/tag/v0.1.2) in [DevzoneCommunity/faag_cli](https://github.com/DevzoneCommunity/faag_cli)
